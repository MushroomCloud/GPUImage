...
- (void)updateOrientationSendToTargets
{
    if ([self cameraPosition] == AVCaptureDevicePositionBack)
    {
        if (_horizontallyMirrorRearFacingCamera)
        {
            ...
            {
                case UIInterfaceOrientationPortrait: [self setRotationMode:kGPUImageRotateRightFlipVertical]; break;
                case UIInterfaceOrientationPortraitUpsideDown: [self setRotationMode:kGPUImageRotate180]; break;
                case UIInterfaceOrientationLandscapeLeft: [self setRotationMode:kGPUImageFlipHorizonal]; break;
                case UIInterfaceOrientationLandscapeRight: [self setRotationMode:kGPUImageFlipVertical]; break;
                default: [self setRotationMode:kGPUImageNoRotation];
            }
        }
        else
        {
            ...
            {
                case UIInterfaceOrientationPortrait: [self setRotationMode:kGPUImageRotateRight]; break;
                case UIInterfaceOrientationPortraitUpsideDown: [self setRotationMode:kGPUImageRotateLeft]; break;
                case UIInterfaceOrientationLandscapeLeft: [self setRotationMode:kGPUImageRotate180]; break;
                case UIInterfaceOrientationLandscapeRight: [self setRotationMode:kGPUImageNoRotation]; break;
                default: [self setRotationMode:kGPUImageNoRotation];
            }
        }
    }
    else
    {
        if (_horizontallyMirrorFrontFacingCamera)
        {
            ...
            {
                case UIInterfaceOrientationPortrait: [self setRotationMode:kGPUImageRotateRightFlipVertical]; break;
                case UIInterfaceOrientationPortraitUpsideDown: [self setRotationMode:kGPUImageRotateRightFlipHorizontal]; break;
                case UIInterfaceOrientationLandscapeLeft: [self setRotationMode:kGPUImageFlipHorizonal]; break;
                case UIInterfaceOrientationLandscapeRight: [self setRotationMode:kGPUImageFlipVertical]; break;
                default: [self setRotationMode:kGPUImageNoRotation];
           }
        ...
        else
        {
            switch(_outputImageOrientation)
            {
                case UIInterfaceOrientationPortrait: [self setRotationMode:kGPUImageRotateRight]; break;
                case UIInterfaceOrientationPortraitUpsideDown: [self setRotationMode:kGPUImageRotateLeft]; break;
                case UIInterfaceOrientationLandscapeLeft: [self setRotationMode:kGPUImageNoRotation]; break;
                case UIInterfaceOrientationLandscapeRight: [self setRotationMode:kGPUImageRotate180]; break;
                default: [self setRotationMode:kGPUImageNoRotation];
            }
        }
    }
...
- (void)setRotationMode:(GPUImageRotationMode)rotationMode
{
    ...
    runSynchronouslyOnVideoProcessingQueue(^
    {
        if (strongself->captureAsYUV && [GPUImageContext supportsFastTextureUpload])
        {
            ...
            strongself->internalRotation = rotationMode;
        }
        else
        {
            strongself->outputRotation = rotationMode;
        }
